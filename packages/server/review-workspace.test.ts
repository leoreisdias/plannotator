...
describe("review-workspace", () => {
  describe("ESLint check API", () => {
    it("advertises and runs the reviewed project's local ESLint for the current snapshot", async () => {
      const dir = makeTempDir("plannotator-eslint-server-");
